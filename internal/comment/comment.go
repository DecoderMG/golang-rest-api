...
// GetComment - retrieves comment by it's ID from the database
...
// GetCommentsbySlug - retrieves comments by a specific slug
...
// GetAllComments - retrieved all comments from the database
